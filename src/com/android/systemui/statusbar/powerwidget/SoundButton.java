...
/*
    <string name="toggleSound">Sound</string>
    <string name="toggleSilent">Silent</string>
    <string name="toggleRing">Ring</string>
    <string name="toggleVibrate">Vibrate</string>
    <string name="toggleSoundVibrate">Sound+Vibrate</string>
*/
    ...
    protected void updateState() {
        ...
        switch (mRingersIndex) {
            case 0:
                ...
                updateTextView(R.id.power_widget_button_text,R.string.toggleSilent);
                break;
            case 1:
                mIcon = R.drawable.stat_vibrate_off;
                mState = STATE_DISABLED;
                updateTextView(R.id.power_widget_button_text,R.string.toggleVibrate);
                break;
            case 2:
                mIcon = R.drawable.stat_ring_on;
                mState = STATE_ENABLED;
                updateTextView(R.id.power_widget_button_text,R.string.toggleRing);
                break;
            case 3:
                mIcon = R.drawable.stat_ring_vibrate_on;
                mState = STATE_ENABLED;
                updateTextView(R.id.power_widget_button_text,R.string.toggleSoundVibrate);
                break;
        }
