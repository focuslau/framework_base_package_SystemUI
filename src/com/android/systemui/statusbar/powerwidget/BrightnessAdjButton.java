...
// display a seekbar for user to adjust the brightness

public class BrightnessAdjButton extends PowerButton {

    private static final String TAG = "BrightnessAdjButton";
    ...
    public BrightnessAdjButton() {
        mType = BUTTON_MANUAL_BRIGHTNESS;
    }
    ...
    protected void setupButton(View view) {
        ...
        if(mView != null) {
            ...
            mView.findViewById(R.id.power_widget_button_image).setVisibility(View.GONE);
            mView.findViewById(R.id.power_widget_button_text).setVisibility(View.GONE);
            mSeekBar = (SeekBar)mView.findViewById(R.id.brightness_seek);
    ...
    protected void updateState() {
        ...
        if(!mAutoBrightness) {
            mSeekBar.setProgress(mCurrentBacklightIndex);
	}
    }
	...
	public void onProgressChanged(SeekBar seekBar, int process, boolean fromUser) {
            if(!fromUser)return;
            mCurrentBacklightIndex = process;
            toggleState();
	}
