...
public class PhoneStatusBar extends StatusBar {
    ...
    // the notifycation container
    View mNotifyContainer;
    ...
    protected View makeStatusBarView() {
        ...
        //setup tab host.lanpeng added 10:56,2012/02/07

	mTabHost = (TabHost) View.inflate(mContext, R.layout.status_bar_tabhost, null);
	mTabHost.setup();

        mTabWidget = (TabWidget) mTabHost.findViewById(android.R.id.tabs);
	// 注册布局
        mNotifyContainer = View.inflate(mContext, R.layout.status_bar_notification, mTabHost.getTabContentView());
        View powerWidgetContainer = View.inflate(mContext, R.layout.status_bar_powerwidget, mTabHost.getTabContentView());
	mPowerWidget = (PowerWidget)powerWidgetContainer.findViewById(R.id.exp_power_stat);
	mTabHost.addTab(mTabHost.newTabSpec("0").setIndicator(mContext.getString(R.string.status_bar_notifycation))
				.setContent(R.id.latest_view_container));
	mTabHost.addTab(mTabHost.newTabSpec("1").setIndicator(mContext.getString(R.string.status_bar_powerwidget))
				.setContent(R.id.exp_power_container));

	mTabHost.setLayoutParams(new LinearLayout.LayoutParams(
		LinearLayout.LayoutParams.FILL_PARENT,
		LinearLayout.LayoutParams.FILL_PARENT, 0F));
        expanded.addView(mTabHost);

        //setup tab host.lanpeng added 10:56,2012/02/07 end


        mExpandedDialog = new ExpandedDialog(context);
        mExpandedView = expanded;
        mPile = (NotificationRowLayout)mNotifyContainer.findViewById(R.id.latestItems);
        mExpandedContents = /*mPile*/expanded; // was: expanded.findViewById(R.id.notificationLinearLayout);
        mNoNotificationsTitle = (TextView)mNotifyContainer.findViewById(R.id.noNotificationsTitle);
        ...
        mSettingsButton.setOnLongClickListener(mSettingsButtonLongClickListener);
        mScrollView = (ScrollView)mNotifyContainer.findViewById(R.id.scroll);


        //mPowerWidget = (PowerWidget)expanded.findViewById(R.id.exp_power_stat);
        //mNotifyContainer = expanded.findViewById(R.id.latest_view_container);
...
//lanpeng add to test 00:33
//        mExpandedDialog.getWindow().setAttributes(mTrackingParams);
		...
		public void onClick(View v) {
			try {
				...
				ActivityManagerNative.getDefault()
                        ...
                        // 暂时留空，如果选择为通知页时，当进入开关设置界面，否则进入系统设置界面，蓝鹏,11:44,2012/02/07
    ...
    private View.OnLongClickListener mSettingsButtonLongClickListener = new View.OnLongClickListener() {
        public boolean onLongClick(View v) {
